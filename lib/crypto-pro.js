...
exports.createDetachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, messageHash) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let publicKeyAlgorithmValue;
    cadesCertificate.PublicKey().then((obj) => {
      obj.Algorithm.then((algorithm) => {
        algorithm.Value.then((value) => {
          publicKeyAlgorithmValue = value;
        })
      })
    })
    ...
    return eval(_generateCadesFn_1._generateCadesFn(function createDetachedSignature() {
        ...
        try {
          // console.log(publicKeyAlgorithmValue)
          if (publicKeyAlgorithmValue === "1.2.643.7.1.1.1.1") {
          ...
          if (publicKeyAlgorithmValue === "1.2.643.7.1.1.1.2") {
            void (_generateCadesFn_1.__cadesAsyncToken__ +
              cadesHashedData.propset_Algorithm(cadesplugin.CADESCOM_HASH_ALGORITHM_CP_GOST_3411_2012_512));
          }
